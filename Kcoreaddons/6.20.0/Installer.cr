class Target < ISM::Software
    ...
    def configure
        ...
        runCmakeCommand(arguments:  "-DCMAKE_INSTALL_PREFIX=/usr        \
                                    ...
                                    -DPySide6_DIR=/usr/lib/python#{softwareMajorVersion("@ProgrammingLanguages-Main:Python")}.#{softwareMinorVersion("@ProgrammingLanguages-Main:Python")}/site-packages/PySide6/lib/cmake/PySide6  \
                                    -Wno-dev                            \
                                    ..",
